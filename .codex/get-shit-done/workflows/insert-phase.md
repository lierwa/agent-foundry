...
```bash
INIT=$(node "/Users/junxi/Desktop/work/agent-foundry/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/junxi/Desktop/work/agent-foundry/.codex/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
