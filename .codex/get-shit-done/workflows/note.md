...
- **Global scope**: `/Users/junxi/Desktop/work/agent-foundry/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/junxi/Desktop/work/agent-foundry/.codex/notes/`)
...
2. Glob `/Users/junxi/Desktop/work/agent-foundry/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/junxi/Desktop/work/agent-foundry/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/junxi/Desktop/work/agent-foundry/.codex/notes/` — works in any directory
